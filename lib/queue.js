...
class Queue extends EventEmitter {
  constructor (options, jobs) {
    ...
    this.connection.on('redis_connect', (options) => { this.emit('redis_connect', options) })
    this.connection.on('redis_close', (options) => { this.emit('redis_close', options) })
    this.connection.on('redis_reconnecting', (options) => { this.emit('redis_reconnecting', options) })
  }
