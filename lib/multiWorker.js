...
class MultiWorker extends EventEmitter {
  ...
  async startWorker () {
    ...
    worker.on('redis_connect', (options) => { this.emit('redis_connect', options) })
    worker.on('redis_close', (options) => { this.emit('redis_close', options) })
    worker.on('redis_reconnecting', (options) => { this.emit('redis_reconnecting', options) })
